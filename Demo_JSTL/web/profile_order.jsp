...
<div id="content-right">
    ...
    <div class="content-main">
        <div id="profile-content-order">
            <div>
                <c:forEach items="${listN}" var="l" varStatus="s">
                    <div class="profile-order-title">
                        ...
                        <div class="profile-order-title-right">
                            <span>Pending || <a href="${pageContext.request.contextPath}/account/profile/order_cancel?oid=${l.orderID}">Cancel</a></span>
                        </div>
                    </div>
            ...
            <div>
                <c:forEach items="${listC}" var="listc" varStatus="i">
                    <div class="profile-order-title">
                        <div class="profile-order-title-left">
                            <div>Order creation date: ${listc.orderDate}</div>
                            <div>Order: ${i.count}</div>
                        </div>
                        <div class="profile-order-title-right">
                            <span style="color: blue;">Completed</span>
                        </div>
                    </div>
                    <c:forEach items="${listc.allOrderDetails}" var="p">
                        <div class="profile-order-content">
                            <div class="profile-order-content-col1">
                                <a href="#"><img src="${pageContext.request.contextPath}/img/2.jpg" width="100%"/></a>
                            </div>
